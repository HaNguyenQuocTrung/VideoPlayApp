...
class CreateVideoList:
    def __init__(self, window):
        ...
        self.bg_color = "#4267B2"         # Facebook blue
        self.fg_color = "#1C1E21"         # White text
        self.button_color = "#1877F2"     # Facebook blue
        self.button_hover_color = "#365899"  # Darker blue
        self.button_text_color = "#FFFFFF"  # White text for buttons
